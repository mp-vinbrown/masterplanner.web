...
$('#filter2 a').click(function (e) {
    ...
    $('#filter2 li').removeClass('active');
    $(this).parent('li').addClass('active');

    var categoryToFilter = $(this).attr('data-filter');

    $('.reference-item2').each(function () {
	if ($(this).data('category') === categoryToFilter || categoryToFilter === 'all') {
	    $(this).removeClass('hidden');
	}
	else {
	...
	$('#references-masonry2').masonry2('reloadItems').masonry2('layout');
...
$('.reference-item2').click(function (e) {
    e.preventDefault();

    var element = $(this);
    var title = element.find('.reference-title').text();
    var description = element.find('.reference-description2').html();

    images = element.find('.reference-description2').data('images').split(',');
    ...
    $('#detail2-title').text(title);
    $('#detail2-content').html(description);
    $('#detail2-slider').html(slider);
...
function openReference2() {

    $('#detail2').addClass('open');
    $('#references-masonry2').animate({opacity: 0}, 300);
    $('#detail2').animate({opacity: 1}, 300);

    setTimeout(function () {
	$('#detail2').slideDown();
	$('#references-masonry2').slideUp();

	if ($('#detail2-slider').html() !== '') {

	    $('#detail2-slider').owlCarousel({
		slideSpeed: 300,
		paginationSpeed: 400,
		autoPlay: true,
		stopOnHover: true,
    ...
    setTimeout(function () {
	$('body').scrollTo($('#detail2'), 1000, {offset: -80});
    }, 500);
...
function closeReference2() {
    ...
    $('#detail2').animate({'opacity': 0}, 300);

    setTimeout(function () {
	$('#detail2').slideUp();
	$('#detail2-slider').data('owlCarousel').destroy();
	$('#references-masonry2').slideDown().animate({'opacity': 1}, 300).masonry2('reloadItems').masonry2();
    ...
    setTimeout(function () {
	$('#references-masonry2').masonry2('reloadItems').masonry2();
    }, 800);

}

$('#detail2 .close').click(function () {
    closeReference2(true);
})
